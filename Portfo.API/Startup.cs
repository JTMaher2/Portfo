...
using Portfo.API.Common.Attributes;
using Portfo.API.Common.Extensions;
using Portfo.API.Common.Middlewares;
using Portfo.API.Common.Settings;
using Portfo.API.Swagger;
using Portfo.IoC.Configuration.DI;

#pragma warning disable CS1591
namespace Portfo.API
{
            ...
            try
            {
                if (_appSettings.IsValid())
                {
                    ...
                    options => {
                        ...
                        // can also be used to control the format of the API version in route portfos
